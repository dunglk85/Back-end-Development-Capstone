...
def login_view(request):
    if request.method == "POST":
        ...
        try:
            ...
            return render(request, "login.html", {"form": LoginForm, "message": "name is not exist"})
    return render(request, "login.html", {"form": LoginForm, "message": "password is not correct"})
